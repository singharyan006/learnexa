...
export default function Footer() {
    return (
        <footer className="bg-background-main border-t border-surface-card px-4 md:px-20 lg:px-40 py-16">
            <div className="max-w-[1280px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
                        <div className="flex items-center gap-3">
                            <span className="material-symbols-outlined text-primary text-3xl">school</span>
                            <h2 className="text-text-heading text-xl font-bold">Learnexa</h2>
                        </div>
                    ...
                    <div>
                        <h4 className="text-text-heading font-bold mb-6">Product</h4>
                    ...
                    <div>
                        <h4 className="text-text-heading font-bold mb-6">Support</h4>
                        <ul className="flex flex-col gap-4 text-text-muted text-sm">
                    ...
                    <div>
                        <h4 className="text-text-heading font-bold mb-6">Newsletter</h4>
                        <p className="text-text-muted text-xs mb-4">Stay updated with the latest in EdTech.</p>
                        <div className="flex gap-2">
                            <input
                                className="flex-1 bg-surface-card border-none rounded-lg text-sm px-4 focus:ring-2 focus:ring-primary text-text-heading"
                                placeholder="Email"
                                type="email"
                            />
                            <button className="p-2 bg-primary text-text-heading rounded-lg hover:bg-primary/90">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-surface-card gap-6">
                    <p className="text-[#616f89] dark:text-gray-500 text-sm">
                        © 2024 Learnexa. All rights reserved.
                    </p>
                    <div className="flex items-center gap-8">
                        <Link className="text-[#616f89] dark:text-gray-500 text-sm hover:text-[#111318] dark:hover:text-text-heading transition-colors" href="#">
                            Privacy Policy
                        </Link>
                        <Link className="text-[#616f89] dark:text-gray-500 text-sm hover:text-[#111318] dark:hover:text-text-heading transition-colors" href="#">
                            Terms of Service
