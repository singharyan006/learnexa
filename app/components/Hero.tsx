export default function Hero() {
    return (
        <section className="px-4 md:px-20 lg:px-40 py-16 md:py-28 bg-white dark:bg-background-dark">
            <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                <div className="flex flex-col gap-8 w-full md:w-1/2">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <button className="flex min-w-[180px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-background-light dark:bg-gray-800 text-[#111318] dark:text-white text-base font-bold hover:bg-gray-200 dark:hover:bg-gray-700 transition-all border border-[#dbdfe6] dark:border-gray-700">
                ...
                <div className="w-full md:w-1/2 relative">
                    <div className="aspect-square w-full rounded-2xl bg-gradient-to-tr from-primary/20 to-blue-50 dark:from-primary/10 dark:to-gray-800 overflow-hidden shadow-2xl border border-white dark:border-gray-700 p-4">
                        <div
                    ...
                    <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-xl border border-[#f0f2f4] dark:border-gray-700 hidden lg:block">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Implementation Rate</p>
                                <p className="text-lg font-bold text-[#111318] dark:text-white">99.8% Success</p>
                            </div>
                        </div>
                    </div>
                </div>
