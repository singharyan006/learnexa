export default function Features() {
    ...
    return (
        <section id="features" className="px-4 md:px-20 lg:px-40 py-24 bg-transparent border-t border-surface-card/20">
            <div className="max-w-[1280px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="group flex flex-col gap-6 rounded-2xl border border-surface-card bg-surface-card/50 p-8 hover:shadow-2xl hover:border-hover-glow/30 transition-all duration-300"
                        >
                            <div className="size-14 rounded-xl bg-primary/10 text-primary flex items-center justify-center group-hover:bg-primary group-hover:text-text-heading transition-all duration-300">
                                <span className="material-symbols-outlined text-3xl">{feature.icon}</span>
                            </div>
                            <div className="flex flex-col gap-3">
                                <h3 className="text-text-heading text-xl font-bold leading-tight">
                                    {feature.title}
                                </h3>
